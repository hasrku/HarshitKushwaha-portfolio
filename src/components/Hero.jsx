...
const Hero = () => {
    ...
    return (
        <div
            id="home"
            className="min-h-[90vh] items-center lg:justify-center pt-16 lg:pt-40 flex flex-col-reverse lg:flex-row px-0 md:px-20 lg:px-[0%] z-20 overflow-hidden"
        >
            <div className="px-4 mt-10 lg:mt-0 lg:px-0 lg:w-[550px]">
                <p className="text-xl md:text-3xl">hi,</p>
                <h1 className="text-xl md:text-3xl h-10 flex items-baseline">
                    I'm &nbsp;
                    <motion.span
                        key={index}
                        initial={{ width: "0px" }}
                        ...
                        className=" bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent relative text-[32px] md:text-5xl font-semibold whitespace-nowrap overflow-hidden inline-block h-16 "
                    >
                        {typingNames[index]}
                        <CursorBlinker />
                    </motion.span>
                ...
                <span
                    className="text-[32px] md:text-5xl font-semibold whitespace-nowrap invisible absolute"
                    ref={textRef}
                >
                    {typingNames[index]}
                </span>

                <p className="mt-2 pr-5 lg:pr-0 md:mt-5 text-lg md:text-xl lg:w-5/6 text-justify lg:text-left">
                ...
                <div className="flex  md:ml-2 mt-5 md:mt-9 gap-5 md:gap-9">
                    <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="text-lg px-5 md:px-8 py-3 md:py-4 cursor-pointer z-30 bg-seccol rounded-4xl flex justify-center items-center gap-3"
                    >
                    ...
                    >
                        <Link
                            ...
                            duration={500}
                            offset={-80}
                            className="text-lg px-5 md:px-8 py-3 md:py-4 cursor-pointer bg-transparent backdrop-blur-2xl border-2 border-seccol rounded-4xl flex justify-center items-center gap-3"
                        >
            ...
            <div className="w-[350px] md:w-[400px] lg:w-[500px] h-full relative lg:mr-10">
                <img
                    src={manLaptop}
                    alt="man with laptop"
